...
const INITIAL_STATE = [
    ...
    {id:7, seller: true, discount: 20,name:'Iphone 12', price:2000, pic:pic.iphone12},
    {id:8, seller: false, discount: 0,name:'Samsong Galaxy A03', price:3000, pic:pic.galaxyA03},
    {id:9, seller: true, discount: 0,name:'Samsong Galaxy A12', price:5000, pic:pic.galaxyA12},
    {id:10, seller: false, discount: 10,name:'Iphone 11', price:6000, pic:pic.iphone11},
    {id:11, seller: true, discount: 15,name:'Iphone 13 proMAX', price:6000, pic:pic.iphone13proMAX},
    {id:12, seller: false, discount: 30,name:'Redmi A9', price:6000, pic:pic.redmiA9},
]
